export const content = {
  es: {
    meta: {
      title: 'Alejandro Esteve Maza | Desarrollador Full Stack',
      description:
    ...
    contact: {
      title: 'Contacto',
      subtitle:
        'Si quieres contratarme o colaborar, escribeme o conectemos en LinkedIn.',
  ...
  en: {
    meta: {
      title: 'Alejandro Esteve Maza | Full-Stack Developer',
      description:
    ...
    contact: {
      title: 'Contact',
      subtitle:
        'If you want to hire me or collaborate, email me or connect on LinkedIn.',
      emailLabel: 'Email',
      linkedinLabel: 'LinkedIn',
    },
    footer: {
